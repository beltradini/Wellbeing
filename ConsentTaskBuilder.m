...
+ (ORKOrderedTask *)buildConsentTask {
    ...
    ORKVisualConsentStep *visualStep = [[ORKVisualConsentStep alloc] initWithIdentifier:@"VisualConsent"
                                                                         document:document];
    ORKConsentReviewStep *reviewStep = [[ORKConsentReviewStep alloc] initWithIdentifier:@"ConsentReview"
                                                                               signature:signature
                                                                              inDocument:document];
